export const ThemeSwitcher = () => {
	return (
		<div id="theme-switch" class="flex text-cinnamon dark:text-lazer">
			<input
				id="theme-toggle"
				type="checkbox"
				name="theme-toggle"
			...
			<label
				id="switch-label"
				for="theme-toggle"
				class="flex h-6 w-6 cursor-pointer items-center justify-center overflow-hidden duration-150 hover:scale-125 xl:h-10 xl:w-10"
